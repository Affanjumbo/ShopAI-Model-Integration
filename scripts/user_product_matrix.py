...
ecom_df = pd.read_csv("F:/ShopAI-AI-Models/datasets/cleaned_ecommerce.csv")
supermarket_df = pd.read_csv("F:/ShopAI-AI-Models/datasets/cleaned_supermarket.csv")
...
# Save matrices
ecom_interaction.to_csv("F:/ShopAI-AI-Models/datasets/ecom_user_product_matrix.csv")
supermarket_interaction.to_csv("F:/ShopAI-AI-Models/datasets/supermarket_user_product_matrix.csv")

ecom_popularity.to_csv("F:/ShopAI-AI-Models/datasets/ecom_product_popularity.csv", index=False)
supermarket_popularity.to_csv("F:/ShopAI-AI-Models/datasets/supermarket_product_popularity.csv", index=False)

ecom_similarity_df.to_csv("F:/ShopAI-AI-Models/datasets/ecom_user_similarity.csv")
supermarket_similarity_df.to_csv("F:/ShopAI-AI-Models/datasets/supermarket_user_similarity.csv")
