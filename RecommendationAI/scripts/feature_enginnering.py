...
output_ecom_test = "RecommendationAI/datasets/ecommerce_test.csv"

output_supermarket_train = "RecommendationAI/datasets/supermarket_train.csv"
output_supermarket_test = "RecommendationAI/datasets/supermarket_test.csv"
